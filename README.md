...
* **Service now "Change request":** If a Service Now "Change request" number is copied on to the clipboard, then opening a new tab will automatically navigate to the Service Now Change Request page. Similarly configure Service now (SNOW) incidents, requests etc.
